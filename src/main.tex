...
\part{大多是诗}
    \input{./诗/2016.1.5-毕赣.tex}
    
    \myquotepage{Sienna}{蒹葭苍苍，白露为霜。所谓伊人，在水一方。}{ ——《诗经·秦风》}\newpage
    \input{./诗/镜中-张枣.tex}
    
    \input{./诗/穿越大半个中国去睡你-余秀华.tex}
    \input{./诗/我爱你-余秀华.tex}
    \input{./诗/涉江采芙蓉-佚名.tex}
    \input{./诗/风从田野上吹过-余秀华.tex}
    \input{./诗/雨霖铃-柳永.tex}
    \input{./诗/写给门前的一棵树-余秀华.tex}
    \input{./诗/少年游-周邦彦.tex}
    \input{./诗/真的-北岛.tex}
    \input{./诗/送别-王维.tex}
    \input{./诗/错误-郑愁予.tex}
    \input{./诗/春思-李白.tex}
    \input{./诗/十二月十九夜-废名.tex}
    \input{./诗/晚晴-李商隐.tex}
    
    \myquotepage{Sienna}{生年不满百，常怀千岁忧。昼短苦夜长，何不秉烛游？}{ ——《古诗十九首·生年不满百》}\newpage
    \input{./诗/春夜宴从弟桃花园序-李白.tex}
